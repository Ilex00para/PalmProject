...
def main(site):
    ...
    Phenological_Data, Meteorological_Data = load_data(dir='/home/u108-n256/PalmProject/NeuralNetwork_Testing',site=site)

    #Saving the raw data /home/u108-n256/PalmProject/NeuralNetwork_Testing/NN_Inputs/{site}/RAW_Phenological_Data.npy
    np.save(f'/home/u108-n256/PalmProject/NeuralNetwork_Testing/NN_Inputs/{site}/RAW_Phenological_Data', Phenological_Data)
    np.save(f'/home/u108-n256/PalmProject/NeuralNetwork_Testing/NN_Inputs/{site}/RAW_Meteorological_Data', Meteorological_Data)
    ...
    np.save(f'/home/u108-n256/PalmProject/NeuralNetwork_Testing/NN_Inputs/{site}/NN_Inputs_raw', NN_inputs)

    #Splitting the data into training and testing data
    NN_IN_Train, NN_IN_Test = train_test_split(NN_inputs, test_size=0.2, random_state=42, shuffle=False)

    np.save(f'/home/u108-n256/PalmProject/NeuralNetwork_Testing/NN_Inputs/{site}/NN_Inputs_Train', NN_IN_Train)
    np.save(f'/home/u108-n256/PalmProject/NeuralNetwork_Testing/NN_Inputs/{site}/NN_Inputs_Test', NN_IN_Test)
